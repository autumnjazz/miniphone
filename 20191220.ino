...
void loop() {
  ...
  } else if(isRead == 0 && message_cnt !=0) {
...
void showTemperature(){
  ...
  temperature = (5.0 * analogRead(lm35Pin) * 100.0) / 1024 - 12;   // 섭씨로 변경
  String temp_data = String(temperature) + "c";

  // sprintf(temp_data, "%8s ℃", String(temperature, 2).c_str());
